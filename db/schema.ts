...
export const leads = pgTable(
  "leads",
  {
    ...
    callStatus: text("call_status").notNull().default("not_started"),
    emailStatus: text("email_status").notNull().default("not_started"),
    whatsappStatus: text("whatsapp_status").notNull().default("not_started"),
    nextAction: text("next_action").notNull().default("review"),
    nextActionAt: timestamp("next_action_at", { withTimezone: true }),
    contactLocked: boolean("contact_locked").notNull().default(false),
    contactLockReason: text("contact_lock_reason").notNull().default(""),
  ...
  (table) => [
    ...
    index("leads_crm_updated_idx").on(table.workspaceId, table.updatedAt),
    index("leads_crm_owner_updated_idx").on(table.workspaceId, table.ownerId, table.updatedAt),
