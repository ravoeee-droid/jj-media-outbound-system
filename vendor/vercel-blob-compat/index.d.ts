...
export declare function get(pathOrUrl: string, options?: { access?: "private" | "public"; useCache?: boolean; headers?: HeadersInit }): Promise<{ stream: ReadableStream<Uint8Array> | null; headers: Headers; statusCode: number; blob: { contentType: string; size: number }; contentType: string; size: number; pathname: string; url: string } | null>;
